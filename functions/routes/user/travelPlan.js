...
router.post("/travelPlan/dailyPlan/scheduleItem/update", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({dailyPlan: selectedDailyPlan, message: "Schedule edited successfully",
      eventId: travelPlanId});
  } catch (error) {
    res.status(500).json({
...
router.delete("/travelPlan/dailyPlan/scheduleItem/delete", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({dailyPlan: selectedDailyPlan, message: "Schedule deleted successfully",
      eventId: travelPlanId});
  } catch (error) {
